...
<!-- Active JS -->
<script
	src="<?php echo base_url(); ?>public/riktheme/js/default-assets/fullscreen.js"></script>
<script
	src="<?php echo base_url(); ?>public/riktheme/js/default-assets/active.js"></script>

<!-- These plugins only need for the run this page -->
<script
	src="<?php echo base_url(); ?>public/riktheme/js/default-assets/dashboard-chat.js"></script>
