...
<table cellspacing="3" cellpadding="3" class="table" align="left">
	<tr>
		<td><?=html_entity_decode($supplier['company'])?></td>
	</tr>
	<tr>
		<td><?=html_entity_decode($supplier['supplier_name'])?></td>
	</tr>
	<tr>
		<td><?=html_entity_decode($supplier['address'])?>
           <br>
          <?=html_entity_decode($supplier['zip'])?>,<?=html_entity_decode($supplier['city'])?>,<?=html_entity_decode($supplier['state'])?></td>
	</tr>
	<tr>
		<td><?=html_entity_decode($supplier['phone_no'])?></td>
	</tr>
	<tr>
		<td><?=html_entity_decode($supplier['email'])?></td>
	</tr>
</table>
...
<table cellspacing="3" cellpadding="3" class="table" align="center">
	...
	<tr>
		<td>Description</td>
		<td><?=html_entity_decode($purchase['description'])?></td>
	</tr>
	<tr>
		<td>Total cost</td>
		<td><?=html_entity_decode($purchase['total_cost'])?></td>
	</tr>
	<tr>
		<td>Amount paid</td>
