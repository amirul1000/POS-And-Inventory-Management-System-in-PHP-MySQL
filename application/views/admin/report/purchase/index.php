<h5 class="font-20 mt-15 mb-1">Report purchase</h5>
<!--Form of products Paramaters-->
<?php echo form_open_multipart('admin/report_purchase/report/',array("class"=>"form-horizontal")); ?>
<div class="card">
	<div class="card-body">
			...
			<div class="col-md-8">
				<select name="report_type">
					<option value="summary"
						<?php if($this->input->post('report_type')=='summary') {echo "selected";}; ?>>Summary</option>
					<option value="details"
						<?php if($this->input->post('report_type')=='details') {echo "selected";}; ?>>Details</option>
				</select>
			</div>
		</div>
	</div>
