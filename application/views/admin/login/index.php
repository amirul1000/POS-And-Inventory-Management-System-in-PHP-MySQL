							...
							<div class="card-body p-4">
								<div class="row align-items-center">
									<div class="col-md-6">
										<div class="xs-d-none">
											<img
												src="<?php echo base_url(); ?>public/riktheme/img/bg-img/6.png"
												alt="">
										</div>
									</div>
									...
									<div class="col-md-6">
                                        ...
                                        <h4 class="font-22 mb-30">Sign
                                         ...
                                         <?php echo form_open_multipart('admin/login/login_process',array("class"=>"form-horizontal")); ?>
											...
											<label class="float-left" for="emailaddress">Email address
										...
										<div class="form-group">
											<a
												href="<?php echo site_url(); ?>/admin/login/forget_password"
                                        ...
                                        <a
											href="<?php echo site_url(); ?>/admin/login/register"
											class="text-dark float-right"><span
