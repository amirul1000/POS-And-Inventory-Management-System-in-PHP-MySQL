...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 24, 2021 at 08:43 AM
...
(1, 'ABC Pharmachy', 'USA', 'US', 'PArk', 'NY', '1212', NULL, NULL, NULL, 'footer content XXXXXXXXX XXXXXXX');
...
CREATE TABLE `product` (
  ...
  `specification` longtext COLLATE utf8_unicode_ci DEFAULT NULL,
  `purchaseType` varchar(20) COLLATE utf8_unicode_ci DEFAULT NULL,
  `assetType` varchar(20) COLLATE utf8_unicode_ci DEFAULT NULL,
  `serial_number` longtext COLLATE utf8_unicode_ci DEFAULT NULL,
...
(9, 'xx@xx.com', 'xx', 'Mr.', 'First name', 'Last name', '', '', '2019-11-14', '', '', '', '', '', '14', '2011-10-19 00:00:00', '2019-11-18 07:19:53', 'super', 'active');
